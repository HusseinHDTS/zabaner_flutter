...
class SettingToggle extends GetxController {
  ...
  void onInit() async {
    ...
    autoScroll.value = (getStorage.read('auto_scroll') ?? "off") == "on";
      ...
      try {
        ...
        if (times.isNotEmpty) {
          ...
          if (request.statusCode == 200) {
            ColoredSnack(title: "تهیه نسخه پشتیبان با موفقیت انجام شد",type: SnackType.SUCCESS);
          }
        }
      } catch (e) {}
    }
  ...
  void getData(bool isGuest) async {
    ...
    if (!isGuest) {
      ...
      if (request.statusCode == 200) {
        ...
        ColoredSnack(title: "بازیابی اطلاعات با موفقیت انجام شد",type: SnackType.SUCCESS);
        ...
        ColoredSnack(title: "بازیابی اطلاعات انجام نشد",type: SnackType.ERROR);
      }
    }
  }
}
