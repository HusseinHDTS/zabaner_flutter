...
const RSA_PUBLIC_KEY = "  ";
const tokenConst =
...
String getUrlFileName(appDir , id , path){
  ...
  result = result.substring(0,result.lastIndexOf(".")).replaceAll(".", "").trim().replaceAll(" ", "").replaceAll("%20", "");
...
String getUrl(path){
  ...
  if(imagePath.contains("/") && imagePath.substring(imagePath.lastIndexOf("/")).replaceAll("/", "") == "undefined" || imagePath.trim().toString() == ""
      || !validImageLink ){
...
bool checkForValidImageLink(String link) {
  ...
  bool valid = false;
  if(link == "jpg" || link == "jpeg" || link == "jfif" || link == "pjpeg" ||
      link == "pjp" || link == "png" || link == "svg" || link == "webp" || link == "apng" || link == "gif" ||
      link == "mp4" || link == "mp3" || link == "avi" || link == "wav" || link == "mov" || link == "wmv" || link == "mkv"
  ){
    valid = true;
  }
    return valid;
