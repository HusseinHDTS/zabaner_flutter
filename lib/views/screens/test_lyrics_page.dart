...
import 'package:zabaner/models/const.dart';

class TestLyricsPage extends StatefulWidget {
  const TestLyricsPage({Key? key}) : super(key: key);

  @override
  _TestLyricsPageState createState() => _TestLyricsPageState();
}

class _TestLyricsPageState extends State<TestLyricsPage> {
