      ...
      child: Directionality(
        ...
        child: Scaffold(
            appBar: ColoredAppBar(
              showBackText: false,
              actions: [
                Container(width:120,child: Center(child:ColoredText(widget.chapterTitle + " / ", textSize: 12, textColor: Colors.white,maxLines: 1,),)),
                SizedBox(width: 2,),
                  ...
                  Container(
                    ...
                    controller.isSubtitleLoaded.value
                      ...
                      children: [
                        ...
                        Obx(() {
                          if (controller.fa.value || controller.en.value) {
