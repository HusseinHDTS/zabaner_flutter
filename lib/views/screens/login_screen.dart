                        ...
                        Align(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Align(alignment:Alignment.center,child: Center(child: ErrorLoading(title: "خطا هنگام دریافت اطلاعات کاربری"))),
                                  SizedBox(
                                    height: 40,
                                  ),
                                  Row(children: [
                                    ...
                                    Flexible(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: InkWell(
                                            onTap: () {
                                              _controller.errorData = false.obs;
                                              _controller.loginCheck.value = true;
                                            },
                                            child: Container(
                                              decoration: BoxDecoration(
                                                  color: redExitColor,
