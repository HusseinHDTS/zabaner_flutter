    ...
    return WillPopScope(
      ...
      child: Directionality(
        ...
        child: Scaffold(
            ...
            body: Directionality(textDirection: TextDirection.ltr,child: controller.obx(
                  (status) {
                    return Column(
                      children: [
                        Container(
                        ...
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Obx(()=> Column(children: List.generate(controller.getParAsLang(controller.fa.value).length, (index){
