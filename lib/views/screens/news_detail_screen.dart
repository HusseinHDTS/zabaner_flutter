...
class _NewsDetailScreenState extends State<NewsDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Container(width: Get.width,height: Get.height,child: Obx(()=>controller.isDataLoaded.isTrue ? Directionality(
                        ...
                        controller.isHide.value
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Obx(() => InkWell(
                                  onTap: () {
                                    controller.togglePlayer(getUrlFileName(controller.appDoc.path,widget.id,controller.newsDetail.podcastPath));
                                  },
                                  child: Icon(
