...
class CustomAnimatedFocusLight extends StatefulWidget {
  ...
  const CustomAnimatedFocusLight({
    Key? key,
...
abstract class AnimatedFocusLightState extends State<CustomAnimatedFocusLight>
