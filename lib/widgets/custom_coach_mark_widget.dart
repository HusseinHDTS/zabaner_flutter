...
import 'package:zabaner/widgets/custom_focus_lignt.dart';

class CustomTutorialCoachMarkWidget extends StatefulWidget {
  const CustomTutorialCoachMarkWidget({
    Key? key,
  ...
  @override
  CustomTutorialCoachMarkWidgetState createState() => CustomTutorialCoachMarkWidgetState();
}

class CustomTutorialCoachMarkWidgetState extends State<CustomTutorialCoachMarkWidget>
