...
import 'package:zabaner/widgets/custom_coach_mark_widget.dart';
...
class CustomTutorialCoachMark {
  ...
  final GlobalKey<CustomTutorialCoachMarkWidgetState> _widgetKey = GlobalKey();
  ...
  OverlayEntry _buildOverlay({bool rootOverlay = false}) {
    return OverlayEntry(
      builder: (context) {
        return CustomTutorialCoachMarkWidget(
          key: _widgetKey,
          targets: targets,
