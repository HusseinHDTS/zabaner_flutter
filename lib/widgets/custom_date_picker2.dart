...
class CustomCalendarDatePicker2 extends StatefulWidget {
  CustomCalendarDatePicker2({
  ...
  @override
  State<CustomCalendarDatePicker2> createState() => _CustomCalendarDatePicker2State();
}

class _CustomCalendarDatePicker2State extends State<CustomCalendarDatePicker2> {
  ...
  @override
  void didUpdateWidget(CustomCalendarDatePicker2 oldWidget) {
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          config: widget.config,
          mode: _mode,
          title: Jalali.fromDateTime(_currentDisplayedMonthDate).formatter.mN + " " + Jalali.fromDateTime(_currentDisplayedMonthDate).formatter.yyyy,
          onTitlePressed: () {
